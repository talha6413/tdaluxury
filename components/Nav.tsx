  ...
  return (
    <header className={`stage15-nav ${compact ? "is-compact" : ""} ${open ? "is-open" : ""}`}>
      <div className="container stage15-nav-inner">
        ...
        <Link
          href="/randevu"
          className="stage15-nav-cta"
          data-conversion-event="appointment_click"
          data-conversion-source="desktop_nav"
        >
        ...
        <button
          type="button"
          className="stage15-mobile-menu"
          onClick={() => setOpen((v) => !v)}
          aria-label="Menü"
          aria-expanded={open}
          aria-controls="stage15-mobile-navigation"
        >
      ...
      {open ? (
        <nav id="stage15-mobile-navigation" className="stage15-mobile-nav" aria-label="Mobil menü">
          ...
          <Link
            ...
            data-conversion-event="appointment_click"
            data-conversion-source="mobile_nav"
          >
            RANDEVU AL
          </Link>
        </nav>
