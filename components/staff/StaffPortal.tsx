"use client";
import { CheckCircle2, Clock3, Camera, BadgeTurkishLira, CalendarDays } from "lucide-react";
...
<div className={styles.cards}><article><CalendarDays/><span>Bugünkü işlem</span><b>7</b></article><article><BadgeTurkishLira/><span>Bu ay prim</span><b>₺4.850</b></article><article><Clock3/><span>Toplam süre</span><b>6 sa 20 dk</b></article></div>
